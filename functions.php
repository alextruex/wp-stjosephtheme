...
if (!function_exists('template_setup')) :
    ...
    function template_setup()
    {
        ...
        register_nav_menus(array(
            'primary' => esc_html__('Primary', 'St Joseph'),
            'secondary' => esc_html__('Secondary', 'St Joseph'),
        ));
...
function template_scripts()
{
    ...
    wp_enqueue_script('template-script', get_template_directory_uri() . '/main.js', array(), '20151215', false);
